...
public class GroundBottom extends Tile{
	private SpriteSheet sheet;
	private Sprite wall;
	public GroundBottom(int x, int y, int width, int heigth, boolean solid, Id id, Handler handler) {
		super(x, y, width, heigth, solid, id, handler);
		sheet = new SpriteSheet("/tiles/city_ground_bottom.png",20,20);
